  ...
  <h4>
    <?php
      if (!empty($user_profile['field_user_title'])) {
        print render($user_profile['field_user_title']) . ' ';
      }
      print render($user_profile['field_user_fname']) . ' ';
      print render($user_profile['field_user_lname']) . ', ';
      print render($user_profile['field_user_party']);
    ?>
  </h4>
  <div>
    <?php print $questions; ?>,
